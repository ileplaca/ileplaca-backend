...
export interface PassingSecretInfo {
    ...
    addSecretInfo: (amount: number | bigint, title: string, description: string, zero_knowledge_proof: string, max_uses: number, info: string) => Promise<void>;
    payForSecretInfoAccess: (secret_info_id: number | string, { value }: {
        value: bigint;
    }) => Promise<void>;
